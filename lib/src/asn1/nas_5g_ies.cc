...
const char* registration_type_5gs_t::registration_type_type_::to_string()
{
  switch (value) {
    case registration_type_5gs_t::registration_type_type_::initial_registration:
      return "initial_registration";
    case registration_type_5gs_t::registration_type_type_::mobility_registration_updating:
      return "mobility_registration_updating";
    case registration_type_5gs_t::registration_type_type_::periodic_registration_updating:
      return "periodic_registration_updating";
    case registration_type_5gs_t::registration_type_type_::emergency_registration:
      return "emergency_registration";
    case registration_type_5gs_t::registration_type_type_::reserved:
      return "reserved";
    default:
...
const char* registration_type_5gs_t::follow_on_request_bit_type_::to_string()
{
  switch (value) {
    case registration_type_5gs_t::follow_on_request_bit_type_::no_follow_on_request_pending:
      return "no_follow_on_request";
    case registration_type_5gs_t::follow_on_request_bit_type_::follow_on_request_pending:
      return "follow_on_request";
    default:
      return "Invalid Choice";
  }
}

const char* de_registration_type_t::switch_off_type_::to_string()
{
  switch (value) {
    case de_registration_type_t::switch_off_type::switch_off:
      return "switch_off";
    case de_registration_type_t::switch_off_type::normal_de_registration:
      return "normal_de_registration";
    default:
      return "Invalid Choice";
  }
}

const char* payload_container_type_t::Payload_container_type_type_::to_string()
{
  switch (value) {
    case payload_container_type_t::Payload_container_type_type::n1_sm_information:
      return "n1_sm_information";
    default:
      return "Invalid Choice";
  }
}

const char* tracking_area_identity_list_5gs_t::type_of_list_type_::to_string()
{
  switch (value) {
    case tracking_area_identity_list_5gs_t::type_of_list_type::list_of_ta_cs_belonging_to_one_plmn_or_snpn_with_non_consecutive_tac_values:
      return "list_of_ta_cs_belonging_to_one_plmn_or_snpn_with_non_consecutive_tac_values";
    case tracking_area_identity_list_5gs_t::type_of_list_type::list_of_ta_cs_belonging_to_one_plmn_or_snpn_with_consecutive_tac_values:
      return "list_of_ta_cs_belonging_to_one_plmn_or_snpn_with_consecutive_tac_values";
    case tracking_area_identity_list_5gs_t::type_of_list_type::list_of_ta_is_belonging_to_different_plm_ns:
      return "list_of_ta_is_belonging_to_different_plm_ns";
    default:
      return "Invalid Choice";
  }
}

const char* tracking_area_identity_list_5gs_t::number_of_elements_::to_string()
{
  switch (value) {
    case tracking_area_identity_list_5gs_t::number_of_elements::number_of_elements_1:
      return "number_of_elements_1";
    case tracking_area_identity_list_5gs_t::number_of_elements::number_of_elements_2:
      return "number_of_elements_2";
    case tracking_area_identity_list_5gs_t::number_of_elements::number_of_elements_3:
      return "number_of_elements_3";
    case tracking_area_identity_list_5gs_t::number_of_elements::number_of_elements_4:
      return "number_of_elements_4";
    case tracking_area_identity_list_5gs_t::number_of_elements::number_of_elements_5:
      return "number_of_elements_5";
    case tracking_area_identity_list_5gs_t::number_of_elements::number_of_elements_6:
      return "number_of_elements_6";
    case tracking_area_identity_list_5gs_t::number_of_elements::number_of_elements_7:
      return "number_of_elements_7";
    case tracking_area_identity_list_5gs_t::number_of_elements::number_of_elements_8:
      return "number_of_elements_8";
    case tracking_area_identity_list_5gs_t::number_of_elements::number_of_elements_9:
      return "number_of_elements_9";
    case tracking_area_identity_list_5gs_t::number_of_elements::number_of_elements_10:
      return "number_of_elements_10";
    case tracking_area_identity_list_5gs_t::number_of_elements::number_of_elements_11:
      return "number_of_elements_11";
    case tracking_area_identity_list_5gs_t::number_of_elements::number_of_elements_12:
      return "number_of_elements_12";
    case tracking_area_identity_list_5gs_t::number_of_elements::number_of_elements_13:
      return "number_of_elements_13";
    case tracking_area_identity_list_5gs_t::number_of_elements::number_of_elements_14:
      return "number_of_elements_14";
    case tracking_area_identity_list_5gs_t::number_of_elements::number_of_elements_15:
      return "number_of_elements_15";
    case tracking_area_identity_list_5gs_t::number_of_elements::number_of_elements_16:
      return "number_of_elements_16";
    default:
      return "Invalid Choice";
  }
}
...
const char* mobile_identity_5gs_t::suci_s::supi_format_type_::to_string()
{
  switch (value) {
    case supi_format_type_::imsi:
      return "imsi";
    case supi_format_type_::network_specific_identifier:
      return "network_specific_identifier";
    case supi_format_type_::gci:
      return "gci";
    case supi_format_type_::gli:
      return "gli";
    default:
      return "Invalid Choice";
  }
...
const char* mobile_identity_5gs_t::suci_s::protection_scheme_id_type_::to_string()
{
  switch (value) {
    case protection_scheme_id_type_::null_scheme:
      return "null_scheme";
    case protection_scheme_id_type_::ecies_scheme_profile_a:
      return "ecies_scheme_profile_a";
    case protection_scheme_id_type_::ecies_scheme_profile_b:
      return "ecies_scheme_profile_b";
    default:
      return "Invalid Choice";
  }
}
...
SRSASN_CODE ue_security_capability_t::pack(asn1::bit_ref& bref)
{
  ...
  if (eps_caps_present == true) {
    ...
    HANDLE_CODE(bref.pack(nea13_supported, 1));
    HANDLE_CODE(bref.pack(nea14_supported, 1));
    ...
    HANDLE_CODE(bref.pack(nia13_supported, 1));
    HANDLE_CODE(bref.pack(nia14_supported, 1));
...
SRSASN_CODE ue_security_capability_t::unpack(asn1::cbit_ref& bref)
{
  ...
  if (length > 2) {
    ...
    HANDLE_CODE(bref.unpack(nea13_supported, 1));
    HANDLE_CODE(bref.unpack(nea14_supported, 1));
    ...
    HANDLE_CODE(bref.unpack(nia13_supported, 1));
    HANDLE_CODE(bref.unpack(nia14_supported, 1));
...
SRSASN_CODE plmn_t::pack(asn1::bit_ref& bref)
{
  HANDLE_CODE(pack_mcc_mnc(mcc.data(), mnc.data(), bref));
  return SRSASN_SUCCESS;
}

SRSASN_CODE plmn_t::unpack(asn1::cbit_ref& bref)
{
  HANDLE_CODE(unpack_mcc_mnc(mcc.data(), mnc.data(), bref));
  return SRSASN_SUCCESS;
}
...
SRSASN_CODE plmn_list_t::pack(asn1::bit_ref& bref)
{
  ...
  for (auto& plmn : plmn_list) {
    HANDLE_CODE(plmn.pack(bref));
  }

  bref.align_bytes_zero();
  uint8_t length = (uint8_t)(ceilf((float)bref.distance(bref_length) / 8) - 1);

  if (length < 5 || length > 47) {
    asn1::log_error("Encoding Failed (PLMN LIST): Packed length (%d) is not in range of min: 5 and max 47 bytes", length);
    return asn1::SRSASN_ERROR_ENCODE_FAIL;
  }
  HANDLE_CODE(bref_length.pack(length, 8));
  return SRSASN_SUCCESS;
...
SRSASN_CODE plmn_list_t::unpack(asn1::cbit_ref& bref)
{
  ...
  HANDLE_CODE(bref.unpack(length, 8));
  if (length < 5 || length > 47) {
    asn1::log_error("Decoding Failed (PLMN LIST): Length (%d) is not in range of min: 5 and max 47 bytes", length);
    return asn1::SRSASN_ERROR_DECODE_FAIL;
  }
  asn1::cbit_ref bref_start = bref;
  while (floorl(bref.distance(bref_start) / 8) < length) {
    plmn_t plmn;
    HANDLE_CODE(plmn.unpack(bref));
    plmn_list.push_back(plmn);
  }
  return SRSASN_SUCCESS;
}
...
SRSASN_CODE tracking_area_identity_list_5gs_t::pack(asn1::bit_ref& bref)
{
  ...
  switch (type_value) {
    case type_of_list_type::list_of_ta_cs_belonging_to_one_plmn_or_snpn_with_non_consecutive_tac_values:{
      non_consecutive_tac_values_s* choice_non_con = srslog::detail::any_cast<non_consecutive_tac_values_s>(&choice_container);
      HANDLE_CODE(choice_non_con->pack(bref, bref_tmp));
      break;}
    case type_of_list_type::list_of_ta_cs_belonging_to_one_plmn_or_snpn_with_consecutive_tac_values:{
      consecutive_tac_values_s* choice_con = srslog::detail::any_cast<consecutive_tac_values_s>(&choice_container);
      HANDLE_CODE(choice_con->pack(bref, bref_tmp));
      break;}
    case type_of_list_type::list_of_ta_is_belonging_to_different_plm_ns:{
      different_plmn_s* choice_diff = srslog::detail::any_cast<different_plmn_s>(&choice_container);
      HANDLE_CODE(choice_diff->pack(bref, bref_tmp));
      break;}
    default:
      log_invalid_choice_id(type_value, "5G NAS TAI LIST INVALID TYPE");
      return asn1::SRSASN_ERROR_ENCODE_FAIL;
  }
...
SRSASN_CODE tracking_area_identity_list_5gs_t::unpack(asn1::cbit_ref& bref)
{
  ...
  HANDLE_CODE(bref.unpack(length, 8));
  HANDLE_CODE(bref.advance_bits(1));
  type_of_list_type e = type_of_list_type::list_of_ta_cs_belonging_to_one_plmn_or_snpn_with_non_consecutive_tac_values;
  HANDLE_CODE(e.unpack(bref));
  set(e);

  number_of_elements num = number_of_elements_::number_of_elements_1;
  HANDLE_CODE(num.unpack(bref));
  set(num);
  uint8_t tmp = 0;
  tmp = getNum(number_of_value);
  switch (type_value)
  {
    case type_of_list_type::list_of_ta_cs_belonging_to_one_plmn_or_snpn_with_non_consecutive_tac_values:{
    choice_container = srslog::detail::any{non_consecutive_tac_values_s()};
    non_consecutive_tac_values_s* choice   = srslog::detail::any_cast<non_consecutive_tac_values_s>(&choice_container);
    HANDLE_CODE(choice->unpack(bref, tmp, length));
    break;}
    case type_of_list_type::list_of_ta_cs_belonging_to_one_plmn_or_snpn_with_consecutive_tac_values:{
    choice_container = srslog::detail::any{consecutive_tac_values_s()};
    consecutive_tac_values_s* choice   = srslog::detail::any_cast<consecutive_tac_values_s>(&choice_container);
    HANDLE_CODE(choice->unpack(bref, tmp, length));
    break;}
    case type_of_list_type::list_of_ta_is_belonging_to_different_plm_ns:{
    choice_container = srslog::detail::any{different_plmn_s()};
    different_plmn_s* choice   = srslog::detail::any_cast<different_plmn_s>(&choice_container);
    HANDLE_CODE(choice->unpack(bref, tmp, length));
    break;}
  default:
        log_invalid_choice_id(type_value, "5G NAS INVALID TYPE");
        return asn1::SRSASN_ERROR_ENCODE_FAIL;
    break;
  }
  if (length != 7) {
...
SRSASN_CODE tracking_area_identity_list_5gs_t::non_consecutive_tac_values_s::pack(asn1::bit_ref& bref, asn1::bit_ref& bref_tmp)
{
  HANDLE_CODE(bref.advance_bits(1));
  // Pack Type of identity                            /*2023---------------11--------29*/
  uint8_t type = static_cast<uint8_t>(tracking_area_identity_list_5gs_t::type_of_list_type_::options:: list_of_ta_cs_belonging_to_one_plmn_or_snpn_with_non_consecutive_tac_values);
  HANDLE_CODE(bref.pack(type, 2));
  uint8_t num_of_ele = static_cast<uint8_t>(number_of_value);
  HANDLE_CODE(bref.pack(num_of_ele, 5));
  HANDLE_CODE(pack_mcc_mnc(plmn.mcc.data(), plmn.mnc.data(), bref));
  for(uint8_t i = 0; i < num_of_ele + 1; i++)
  {
    uint64_t tac_val = struct_tac_to_uint64(tac_t[i]);
    HANDLE_CODE(bref.pack(tac_val, 24));
  }

  return SRSASN_SUCCESS;
}

SRSASN_CODE tracking_area_identity_list_5gs_t::non_consecutive_tac_values_s::unpack(asn1::cbit_ref& bref, uint8_t tmp, uint32_t length)
{
  HANDLE_CODE(unpack_mcc_mnc(plmn.mcc.data(), plmn.mnc.data(), bref));
  
  for(uint8_t i = 0; i < tmp; i++)
  {
    HANDLE_CODE(bref.unpack(tac_t[i].tac[0], 8));
    HANDLE_CODE(bref.unpack(tac_t[i].tac[1], 8));
    HANDLE_CODE(bref.unpack(tac_t[i].tac[2], 8));
  }
...
SRSASN_CODE tracking_area_identity_list_5gs_t::consecutive_tac_values_s::pack(asn1::bit_ref& bref, asn1::bit_ref& bref_tmp)
{
  HANDLE_CODE(bref.advance_bits(1));
  // Pack Type of identity
  uint8_t type = static_cast<uint8_t>(tracking_area_identity_list_5gs_t::type_of_list_type_::options::list_of_ta_cs_belonging_to_one_plmn_or_snpn_with_consecutive_tac_values);
  HANDLE_CODE(bref.pack(type, 2));
  uint8_t num_of_ele = static_cast<uint8_t>(number_of_value);
  HANDLE_CODE(bref.pack(num_of_ele, 5));
  HANDLE_CODE(pack_mcc_mnc(tac_str.plmn.mcc.data(), tac_str.plmn.mnc.data(), bref));
  uint64_t tac_val = struct_tac_to_uint64(tac_str.tac);
  HANDLE_CODE(bref.pack(tac_val, 24));

  return SRSASN_SUCCESS;
}

SRSASN_CODE tracking_area_identity_list_5gs_t::consecutive_tac_values_s::unpack(asn1::cbit_ref& bref, uint8_t tmp, uint32_t length)
{
  HANDLE_CODE(unpack_mcc_mnc(tac_str.plmn.mcc.data(), tac_str.plmn.mnc.data(), bref));
  
  HANDLE_CODE(bref.unpack(tac_str.tac.tac[0], 8));
  HANDLE_CODE(bref.unpack(tac_str.tac.tac[1], 8));
  HANDLE_CODE(bref.unpack(tac_str.tac.tac[2], 8));

  return SRSASN_SUCCESS;
}

SRSASN_CODE tracking_area_identity_list_5gs_t::different_plmn_s::pack(asn1::bit_ref& bref, asn1::bit_ref& bref_tmp)
{
  HANDLE_CODE(bref.advance_bits(1));
  // Pack Type of identity
  uint8_t type = static_cast<uint8_t>(tracking_area_identity_list_5gs_t::type_of_list_type_::options::list_of_ta_cs_belonging_to_one_plmn_or_snpn_with_consecutive_tac_values);
  ...
  uint8_t num_of_ele = static_cast<uint8_t>(number_of_value);
  HANDLE_CODE(bref.pack(num_of_ele, 5));
  for (uint8_t i = 0; i < num_of_ele; i++)
  {
    HANDLE_CODE(pack_mcc_mnc(tac_str[i].plmn.mcc.data(), tac_str[i].plmn.mnc.data(), bref));
    uint64_t tac_val = struct_tac_to_uint64(tac_str[i].tac);
    HANDLE_CODE(bref.pack(tac_val, 24));
  }
...
SRSASN_CODE tracking_area_identity_list_5gs_t::different_plmn_s::unpack(asn1::cbit_ref& bref, uint8_t tmp, uint32_t length)
{
  for(uint8_t i = 0; i < tmp; i++)
  {
    HANDLE_CODE(unpack_mcc_mnc(tac_str[i].plmn.mcc.data(), tac_str[i].plmn.mnc.data(), bref));
    HANDLE_CODE(bref.unpack(tac_str[i].tac.tac[0], 8));
    HANDLE_CODE(bref.unpack(tac_str[i].tac.tac[1], 8));
    HANDLE_CODE(bref.unpack(tac_str[i].tac.tac[2], 8));
  }
...
const char* cause_5gmm_t::cause_5gmm_type_::to_string()
{
  switch (value) {
    case cause_5gmm_t::cause_5gmm_type_::illegal_ue:
      return "illegal_ue";
    case cause_5gmm_t::cause_5gmm_type_::pei_not_accepted:
      return "pei_not_accepted";
    case cause_5gmm_t::cause_5gmm_type_::illegal_me:
      return "illegal_me";
    case cause_5gmm_t::cause_5gmm_type_::services_not_allowed_5gs:
      return "services_not_allowed_5gs";
    case cause_5gmm_t::cause_5gmm_type_::ue_identity_cannot_be_derived_by_the_network:
      return "ue_identity_cannot_be_derived_by_the_network";
    case cause_5gmm_t::cause_5gmm_type_::implicitly_de_registered:
      return "implicitly_de_registered";
    case cause_5gmm_t::cause_5gmm_type_::plmn_not_allowed:
      return "plmn_not_allowed";
    case cause_5gmm_t::cause_5gmm_type_::tracking_area_not_allowed:
      return "tracking_area_not_allowed";
    case cause_5gmm_t::cause_5gmm_type_::roaming_not_allowed_in_this_tracking_area:
      return "roaming_not_allowed_in_this_tracking_area";
    case cause_5gmm_t::cause_5gmm_type_::no_suitable_cells_in_tracking_area:
      return "no_suitable_cells_in_tracking_area";
    case cause_5gmm_t::cause_5gmm_type_::mac_failure:
      return "mac_failure";
    case cause_5gmm_t::cause_5gmm_type_::congestion:
      return "congestion";
    case cause_5gmm_t::cause_5gmm_type_::ue_security_capabilities_mismatch:
      return "ue_security_capabilities_mismatch";
    case cause_5gmm_t::cause_5gmm_type_::security_mode_rejected_unspecified:
      return "security_mode_rejected_unspecified";
    case cause_5gmm_t::cause_5gmm_type_::non_5g_authentication_unacceptable:
      return "non_5g_authentication_unacceptable";
    case cause_5gmm_t::cause_5gmm_type_::n1_mode_not_allowed:
      return "n1_mode_not_allowed";
    case cause_5gmm_t::cause_5gmm_type_::restricted_service_area:
      return "restricted_service_area";
    case cause_5gmm_t::cause_5gmm_type_::redirection_to_epc_required:
      return "redirection_to_epc_required";
    case cause_5gmm_t::cause_5gmm_type_::ladn_not_available:
      return "ladn_not_available";
    case cause_5gmm_t::cause_5gmm_type_::no_network_slices_available:
      return "no_network_slices_available";
    case cause_5gmm_t::cause_5gmm_type_::maximum_number_of_pdu_sessions_reached_:
      return "maximum_number_of_pdu_sessions_reached_";
    case cause_5gmm_t::cause_5gmm_type_::insufficient_resources_for_specific_slice_and_dnn:
      return "insufficient_resources_for_specific_slice_and_dnn";
    case cause_5gmm_t::cause_5gmm_type_::insufficient_resources_for_specific_slice:
      return "insufficient_resources_for_specific_slice";
    case cause_5gmm_t::cause_5gmm_type_::ng_ksi_already_in_use:
      return "ng_ksi_already_in_use";
    case cause_5gmm_t::cause_5gmm_type_::non_3_gpp_access_to_5gcn_not_allowed:
      return "non_3_gpp_access_to_5gcn_not_allowed";
    case cause_5gmm_t::cause_5gmm_type_::serving_network_not_authorized:
      return "serving_network_not_authorized";
    case cause_5gmm_t::cause_5gmm_type_::temporarily_not_authorized_for_this_snpn:
      return "temporarily_not_authorized_for_this_snpn";
    case cause_5gmm_t::cause_5gmm_type_::permanently_not_authorized_for_this_snpn:
      return "permanently_not_authorized_for_this_snpn";
    case cause_5gmm_t::cause_5gmm_type_::not_authorized_for_this_cag_or_authorized_for_cag_cells_only:
      return "not_authorized_for_this_cag_or_authorized_for_cag_cells_only";
    case cause_5gmm_t::cause_5gmm_type_::wireline_access_area_not_allowed:
      return "wireline_access_area_not_allowed";
    case cause_5gmm_t::cause_5gmm_type_::payload_was_not_forwarded:
      return "payload_was_not_forwarded";
    case cause_5gmm_t::cause_5gmm_type_::dnn_not_supported_or_not_subscribed_in_the_slice:
      return "dnn_not_supported_or_not_subscribed_in_the_slice";
    case cause_5gmm_t::cause_5gmm_type_::insufficient_user_plane_resources_for_the_pdu_session:
      return "insufficient_user_plane_resources_for_the_pdu_session";
    case cause_5gmm_t::cause_5gmm_type_::semantically_incorrect_message:
      return "semantically_incorrect_message";
    case cause_5gmm_t::cause_5gmm_type_::invalid_mandatory_information:
      return "invalid_mandatory_information";
    case cause_5gmm_t::cause_5gmm_type_::message_type_non_existent_or_not_implemented:
      return "message_type_non_existent_or_not_implemented";
    case cause_5gmm_t::cause_5gmm_type_::message_type_not_compatible_with_the_protocol_state:
      return "message_type_not_compatible_with_the_protocol_state";
    case cause_5gmm_t::cause_5gmm_type_::information_element_non_existent_or_not_implemented:
      return "information_element_non_existent_or_not_implemented";
    case cause_5gmm_t::cause_5gmm_type_::conditional_ie_error:
      return "conditional_ie_error";
    case cause_5gmm_t::cause_5gmm_type_::message_not_compatible_with_the_protocol_state:
      return "message_not_compatible_with_the_protocol_state";
    case cause_5gmm_t::cause_5gmm_type_::protocol_error_unspecified:
      return "protocol_error_unspecified";
    default:
      return "Invalid 5gmm cause";
  }
}
...
SRSASN_CODE pf_content_t::pack(asn1::bit_ref& bref) 
{
  // Save length bref pointer
  asn1::bit_ref bref_length = bref;
  HANDLE_CODE(bref.advance_bits(8));

  HANDLE_CODE(bref.pack_bytes(pf_content.data(), pf_content.size()));
  bref.align_bytes_zero();
  uint8_t length = (uint8_t)(ceilf((float)bref.distance(bref_length) / 8) - 1);
...
SRSASN_CODE pf_content_t::unpack(asn1::cbit_ref& bref)
{
  uint8_t length = 0;
  HANDLE_CODE(bref.unpack(length, 8));
  if (length != 8) {
    asn1::log_error("Decoding Failed (Authentication failure parameter): Length (%d) does not equal expected length 14",length);
    return asn1::SRSASN_ERROR_DECODE_FAIL;
  }
  pf_content.resize(length);
  HANDLE_CODE(bref.unpack_bytes(pf_content.data(), length));
  return SRSASN_SUCCESS;
}
...
SRSASN_CODE pacret_filter_type2_t::pack(asn1::bit_ref& bref)
{
  HANDLE_CODE(bref.pack(0x0,2));
  HANDLE_CODE(packet_filter_direction.pack(bref));
  HANDLE_CODE(bref.pack(packet_filter_id,4));
  HANDLE_CODE(pf_cont.pack(bref));
  return SRSASN_SUCCESS;
}

SRSASN_CODE pacret_filter_type2_t::unpack(asn1::cbit_ref& bref)
{
  bref.advance_bits(2);
  HANDLE_CODE(packet_filter_direction.unpack(bref));
  HANDLE_CODE(bref.unpack(packet_filter_id,4));
  HANDLE_CODE(pf_cont.unpack(bref));
  return SRSASN_SUCCESS;
}



SRSASN_CODE QFI_cont_t::pack(asn1::bit_ref& bref)
{
  HANDLE_CODE(bref.pack(0x0,1));
  HANDLE_CODE(Segregation.pack(bref));
  HANDLE_CODE(QFI.pack(bref));
  return SRSASN_SUCCESS;
}

SRSASN_CODE QFI_cont_t::unpack(asn1::cbit_ref& bref)
{
  bref.advance_bits(1);
  HANDLE_CODE(Segregation.unpack(bref));
  HANDLE_CODE(QFI.unpack(bref));
  return SRSASN_SUCCESS;
}


SRSASN_CODE packet_filter_t::pack(asn1::bit_ref& bref)
{
  HANDLE_CODE(pacret_filter_type2.pack(bref));
  HANDLE_CODE(bref.pack(Qos_rules_precedence,8));
  HANDLE_CODE(QFI_cont.pack(bref));
  return SRSASN_SUCCESS;
}

SRSASN_CODE packet_filter_t::unpack(asn1::cbit_ref& bref)
{
  HANDLE_CODE(pacret_filter_type2.unpack(bref));
  HANDLE_CODE(bref.unpack(Qos_rules_precedence,8));
  HANDLE_CODE(QFI_cont.unpack(bref));
  return SRSASN_SUCCESS;
}

SRSASN_CODE qos_rule_t::pack(asn1::bit_ref& bref)
{
  
  HANDLE_CODE(QRI.pack(bref));
  
  asn1::bit_ref bref_length = bref;
  HANDLE_CODE(bref.advance_bits(16));
  
  HANDLE_CODE(Rule_operation_code.pack(bref));
  HANDLE_CODE(DQR.pack(bref));
  HANDLE_CODE(bref.pack(packet_filter_num,4));
  HANDLE_CODE(packet_filter.pack(bref));
 
  bref.align_bytes_zero();
  uint8_t length = (uint8_t)(ceilf((float)bref.distance(bref_length) / 8) - 2);
  
  HANDLE_CODE(bref_length.pack(length, 16));
  return SRSASN_SUCCESS;
}

SRSASN_CODE qos_rule_t::unpack(asn1::cbit_ref& bref)
{
  HANDLE_CODE(QRI.unpack(bref));

  uint16_t length = 0;
  HANDLE_CODE(bref.unpack(length, 16));
  
  HANDLE_CODE(Rule_operation_code.unpack(bref));
  HANDLE_CODE(DQR.unpack(bref));
  HANDLE_CODE(bref.unpack(packet_filter_num,4));
  HANDLE_CODE(packet_filter.unpack(bref));
...
SRSASN_CODE qo_s_rules_t::pack(asn1::bit_ref& bref)
{
  ...
  asn1::bit_ref bref_length = bref;
  HANDLE_CODE(bref.advance_bits(16));
  //HANDLE_CODE(qos_rule.pack(bref));
  for(auto& qos_rule : qos_rules )
  {
    HANDLE_CODE(qos_rule.pack(bref)); 
  }
  bref.align_bytes_zero();
...
//HANDLE_CODE(qos_rule.unpack(bref));
...
// IE: QoS flow descriptions
// IE: QoS flow descriptions
SRSASN_CODE QI5_parameter_contents_t::pack(asn1::bit_ref& bref)
{
  HANDLE_CODE(parameter_id1.pack(bref));

  asn1::bit_ref bref_length = bref;
  HANDLE_CODE(bref.advance_bits(8));

  HANDLE_CODE(QI5.pack(bref));
...
SRSASN_CODE QI5_parameter_contents_t::unpack(asn1::cbit_ref& bref)
{
  HANDLE_CODE(parameter_id1.unpack(bref));

  uint16_t length = 0;
  HANDLE_CODE(bref.unpack(length, 8));

   HANDLE_CODE(QI5.unpack(bref));
...
SRSASN_CODE content_t::pack(asn1::bit_ref& bref)
{
  HANDLE_CODE(guaranteed_flow.pack(bref));
  HANDLE_CODE(bref.pack(guaranteed_flow_bit_rate1,8));
  HANDLE_CODE(bref.pack(guaranteed_flow_bit_rate2,8));

  return SRSASN_SUCCESS;
}

SRSASN_CODE content_t::unpack(asn1::cbit_ref& bref)
{
  HANDLE_CODE(guaranteed_flow.unpack(bref));
  HANDLE_CODE(bref.unpack(guaranteed_flow_bit_rate1,8));
  HANDLE_CODE(bref.unpack(guaranteed_flow_bit_rate2,8));

  return SRSASN_SUCCESS;
}

SRSASN_CODE GFBR_uplink_parameter_contents_t::pack(asn1::bit_ref& bref)
{
  HANDLE_CODE(parameter_id2.pack(bref));

  asn1::bit_ref bref_length = bref;
  HANDLE_CODE(bref.advance_bits(8));

  HANDLE_CODE(content.pack(bref));
...
SRSASN_CODE GFBR_uplink_parameter_contents_t::unpack(asn1::cbit_ref& bref)
{
  HANDLE_CODE(parameter_id2.unpack(bref));

  uint16_t length = 0;
  HANDLE_CODE(bref.unpack(length, 8));
  
  HANDLE_CODE(content.unpack(bref));

  HANDLE_CODE(bref.advance_bits(length * 8));
  return SRSASN_SUCCESS;
}

SRSASN_CODE Averaging_window_parameter_contents_t::pack(asn1::bit_ref& bref)
{
  return SRSASN_SUCCESS;
}

SRSASN_CODE Averaging_window_parameter_contents_t::unpack(asn1::cbit_ref& bref)
{
  return SRSASN_SUCCESS;
}

SRSASN_CODE EPS_bearer_identity_parameter_contents_t::pack(asn1::bit_ref& bref)
{
  return SRSASN_SUCCESS;
}

SRSASN_CODE EPS_bearer_identity_parameter_contents_t::unpack(asn1::cbit_ref& bref)
{
  return SRSASN_SUCCESS;
}

// SRSASN_CODE parameter_id_t::pack(asn1::bit_ref& bref)
// {
  
//   return SRSASN_SUCCESS;
// }

// SRSASN_CODE parameter_id_t::unpack(asn1::cbit_ref& bref)
// {
  
//   return SRSASN_SUCCESS;
// }

SRSASN_CODE parameters_list_t::pack(asn1::bit_ref& bref)
{
  for(auto& parameter1 : parameters1 )
  {
    HANDLE_CODE(parameter1.pack(bref));
  }
  for(auto& parameter2 : parameters2 )
  {
    HANDLE_CODE(parameter2.pack(bref));
  }
  
  return SRSASN_SUCCESS;
}

SRSASN_CODE parameters_list_t::unpack(asn1::cbit_ref& bref)
{
  for(auto& parameter1 : parameters1 )
  {
    HANDLE_CODE(parameter1.unpack(bref));
  }
  for(auto& parameter2 : parameters2 )
  {
    HANDLE_CODE(parameter2.unpack(bref));
  }
  return SRSASN_SUCCESS;
}

SRSASN_CODE qo_s_flow_description_t::pack(asn1::bit_ref& bref)
{
  HANDLE_CODE(bref.pack(0x0,2));
  HANDLE_CODE(QFI.pack(bref));
  
  HANDLE_CODE(operation_code.pack(bref));
  HANDLE_CODE(bref.pack(0x0,5));
  
  HANDLE_CODE(bref.pack(0x0,1));
  HANDLE_CODE(E.pack(bref));
  HANDLE_CODE(bref.pack(parameters_num,6));

  HANDLE_CODE(parameters_list.pack(bref));

  return SRSASN_SUCCESS;
}

SRSASN_CODE qo_s_flow_description_t::unpack(asn1::cbit_ref& bref)
{
  bref.advance_bits(2);
  HANDLE_CODE(QFI.unpack(bref));
  
  HANDLE_CODE(operation_code.unpack(bref));
  bref.advance_bits(5);
  
  bref.advance_bits(1);
  HANDLE_CODE(E.unpack(bref));
  HANDLE_CODE(bref.unpack(parameters_num,6));

  HANDLE_CODE(parameters_list.unpack(bref));
...
SRSASN_CODE qo_s_flow_descriptions_t::pack(asn1::bit_ref& bref)
{
  ...
  HANDLE_CODE(bref.advance_bits(16));
  //HANDLE_CODE(qos_rule.pack(bref));
  for(auto& qo_s_flow_description : qo_s_flow_descriptions )
  {
    HANDLE_CODE(qo_s_flow_description.pack(bref)); 
  }
  bref.align_bytes_zero();
  uint16_t length = (uint16_t)(ceilf((float)bref.distance(bref_length) / 8) - 2);
  // max. length of 65535 not checked: uint overflow
...
SRSASN_CODE qo_s_flow_descriptions_t::unpack(asn1::cbit_ref& bref)
{
  ...
  for(auto& qo_s_flow_description : qo_s_flow_descriptions )
  {
    HANDLE_CODE(qo_s_flow_description.unpack(bref));
  }
  // TODO proper unpacking
  HANDLE_CODE(bref.advance_bits(length * 8));
  return SRSASN_SUCCESS;
...
//TC
// ue_test_loop_mode_t
const char* ue_test_loop_mode_t::ue_test_loop_mode_::to_string()
{
  switch (value) {
    case ue_test_loop_mode_t::ue_test_loop_mode_::ue_test_loop_mode_a:
      return "ue_test_loop_mode_a";
    case ue_test_loop_mode_t::ue_test_loop_mode_::ue_test_loop_mode_b:
      return "ue_test_loop_mode_b";
...
SRSASN_CODE ue_test_loop_mode_t::pack(asn1::bit_ref& bref)
{
  HANDLE_CODE(type_value.pack(bref));
  return SRSASN_SUCCESS;
}

SRSASN_CODE ue_test_loop_mode_t::unpack(asn1::cbit_ref& bref)
{
  HANDLE_CODE(type_value.unpack(bref));
  return SRSASN_SUCCESS;
}

// ue_test_loop_mode_a_lb_setup_t
SRSASN_CODE ue_test_loop_mode_a_lb_setup_t::pack(asn1::bit_ref& bref)
{
  HANDLE_CODE(bref.pack(lb_setup_list.size()*3, 8));
  for (uint8_t i = 0; i < lb_setup_list.size(); i++)
  {
    HANDLE_CODE(bref.pack((lb_setup_list.data() + i)->z, 16));
    HANDLE_CODE(bref.pack((lb_setup_list.data() + i)->q, 8));
  }
  return SRSASN_SUCCESS;
}

//ue_test_loop_mode_b_lb_setup_t
SRSASN_CODE ue_test_loop_mode_b_lb_setup_t::pack(asn1::bit_ref& bref)
{
  HANDLE_CODE(bref.pack(ip_pdu_delay, 8));
  return SRSASN_SUCCESS;
}
