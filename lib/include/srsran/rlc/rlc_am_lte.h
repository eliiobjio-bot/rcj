...
#undef RLC_AM_BUFFER_DEBUG
  ...
  private:
#define TX_WAIT_MAX_WINOW_SIZE 1024
    srsran::static_circular_map<uint32_t, T, TX_WAIT_MAX_WINOW_SIZE> window;
  };
  ...
  public:
    ...
    // ttcn
    // bool     ttcn_rlc_enble = false;
    uint16_t ttcn_testId = 0;
    uint8_t my_variable[21];
    uint16_t rlc_rnti;
    bool ttcn_testID_627 = false;
    bool ttcn_testID_626 = false;
    bool ttcn_testID_6213 = false;
    bool ttcn_testID_6211 = false;
    bool ttcn_testID_6212 = false;
    bool ttcn_testID_629 = false;
    bool ttcn_testID_6210 = false;
    int rlcPid = 0;
    bool ttcn_rlc_enble = false;
    void mod_enble(bool ttcn_rlc_enble_);
    void test_ID_enble(uint16_t rlc_testID);
    void setRlcPid(int pid_);
    void TC_6115_RLC_Handle_t() { std::cout << "TC6115 AM Dummy!!" << std::endl; };
    void TC_6116_RLC_Handle_t() { std::cout << "TC6116 AM Dummy!!" << std::endl; };
    void TC_6117_RLC_Handle_t() { std::cout << "TC6117 AM Dummy!!" << std::endl; };
  ...
  private:
    ...
    public:
      ...
      bool configure(const rlc_config_t &cfg_);
      bool wx_configure(const rlc_config_t &cfg_);

      std::chrono::_V2::system_clock::time_point am_end_time;
      std::chrono::_V2::system_clock::time_point am_s1_time;
      std::chrono::_V2::system_clock::time_point am_s2_time;
      std::chrono::_V2::system_clock::time_point am_s3_time;
    ...
    public:
      ...
      bool wx_configure(s_rlc_am_cfg_t cfg_);
