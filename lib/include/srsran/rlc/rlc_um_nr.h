...
namespace srsran
{
  ...
  public:
    ...
    void mod_enble(bool ttcn_rlc_enble_) { std::cout << "c class rlc_um_nr_tx : public rlc_um_base_tx" << std::endl; };
    void test_ID_enble(uint16_t rlc_testID) { std::cout << " class rlc_um_nr_tx : public rlc_um_base_tx" << std::endl; };
    void setRlcPid(int pid_){std::cout<<" UM NR dummy "<<std::endl;};
    void TC_6115_RLC_Handle_t() { std::cout << " class rlc_um_nr_tx : public rlc_um_base_tx" << std::endl; }
    void TC_6116_RLC_Handle_t() { std::cout << " class rlc_um_nr_tx : public rlc_um_base_tx" << std::endl; }
    void TC_6117_RLC_Handle_t() { std::cout << " class rlc_um_nr_tx : public rlc_um_base_tx" << std::endl; }
