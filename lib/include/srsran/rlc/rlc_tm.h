...
namespace srsran
{
  ...
  public:
    ...
    void mod_enble(bool ttcn_rlc_enble_) { std::cout << "class rlc_tm final : public rlc_common" << std::endl; };
    void test_ID_enble(uint16_t rlc_testID) { std::cout << "class rlc_tm final : public rlc_common" << std::endl; };
    void setRlcPid(int pid_){ std::cout<<" TM dummy "<<std::endl;}
    
    void TC_6115_RLC_Handle_t() { std::cout << "class rlc_tm final : public rlc_common" << std::endl; }
    void TC_6116_RLC_Handle_t() { std::cout << "class rlc_tm final : public rlc_common" << std::endl; }
    void TC_6117_RLC_Handle_t() { std::cout << "class rlc_tm final : public rlc_common" << std::endl; }
    // MAC interface
