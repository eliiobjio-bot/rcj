...
public:
  ...
  void TC_6115_RLC_Handle_t();
  void TC_6116_RLC_Handle_t();
  void TC_6117_RLC_Handle_t();
...
private:
  ...
  public:
    ...
    //---------IOT-----------
    void iot_reassemble_rx_sdus();
    //-----------------------
    bool pdu_belongs_to_rx_sdu();
    bool inside_reordering_window(uint16_t sn);
    //-------------IOT------------
    bool iot_inside_reordering_window(uint16_t sn);
    //----------------------------
  ...
  private:
    ...
    //-----------------IOT-----------------------------
    std::map<uint32_t,iot_rlc_umd_pdu_t>iot_rx_window;
    //-------------------------------------------------
...
//----------------------IOT------------------------
uint32_t iot_rlc_um_packed_length(rlc_um_nr_pdu_header_t *header);
//-------------------------------------------------
