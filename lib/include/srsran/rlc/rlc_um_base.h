...
namespace srsran
{
  ...
  public:
    ...
    uint16_t rlc_rnti;
    uint16_t ttcn_rlc_sn = 100;
    bool ttcn_testID_625 = false;
    bool ttcn_testID_621 = false;
    bool ttcn_testID_622 = false;
    bool ttcn_testID_623 = false;
     bool ttcn_testID_624 = false;
    bool ttcn_testID_628 = false;
    bool TC_6115 = false;
    bool TC_6116 = false;
    bool TC_6117 = false;
    int rlcPid = 0;
  ...
  protected:
    ...
    protected:
      ...
      unique_byte_buffer_t iot_rx_sdu;
