...
public:
  ...
  void rlc_ttcn_msg(uint16_t, srsran::unique_byte_buffer_t, uint16_t){};
  ...
  void add_bearer_mrb(uint32_t lcid, const pdcp_config_t& cnfg);
   ...
   //----------------2023.10.20-------------------------
  int  add_bearer(uint32_t lcid, const pdcp_confg_t& cnfg);
  void add_bearer_mrb(uint32_t lcid, const pdcp_confg_t& cnfg);
  //-----------------------------------------------------------------
  ...
  //int sdap_mapping_modfiy(uint32_t lcid,uint8_t qfi);
  int sdap_cfger(uint32_t lcid,const sdap_allocate& sdap_cfg);
