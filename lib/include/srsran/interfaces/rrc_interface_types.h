 ...
 **************************/
//----------------------------------2023.12.12--------------------------------------------------
struct phy_ch_cfog_t {
 
  phy_ch_cfog_t() { set_defaults(); }
  void set_defaults()
  {
    asn1::rrc::rrc_con_recfg_r1_ies_s reconfig_r1;
    reconfig_r1.redio_resour_cfg_dedi_present = true;
    auto& rr_cfg_ded                          = reconfig_r1.redio_resour_cfg_dedi;
    rr_cfg_ded.phy_chan_list_cfg_present      = true;
    rr_cfg_ded.phy_chan_list_cfg.resize(1);
    asn1::rrc::phy_chan_cfg_s& phy_chan = rr_cfg_ded.phy_chan_list_cfg[0];
    ...
    phy_chan.chan_type = asn1::rrc::phy_chan_cfg_s::chan_type_opts::pDCH12;
    phy_chan.band_id.ba_id.from_string("000110");
  ...
  if(phy_chan.chan_type==2||phy_chan.chan_type==4||phy_chan.chan_type==6)
  {
   ...
   // phy_chan.slot_ass.from_string("11000");
    phy_chan.direc_t = asn1::rrc::phy_chan_cfg_s::direct_opts::biDirection;
  }
};
//----------------------------------------------------------------------------------------------
struct phy_cfg_t {
