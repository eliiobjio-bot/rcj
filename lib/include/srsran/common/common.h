...
#define FDD_HARQ_DELAY_DL_MS 240
#define FDD_HARQ_DELAY_UL_MS 240
#define MSG3_DELAY_MS 2 // Delay added to FDD_HARQ_DELAY_DL_MS

#define TTI_SUB(a, b) ((((a) + 254592) - (b)) % 254592)
#define TTI_ADD(a, b) (((a) + (b)) % 254592)
//#define TTI_SUB(a, b) ((((a) + 52) - (b)) % 52)
//#define TTI_ADD(a, b) (((a) + (b)) % 52)
...
#define INVALID_TTI 254593
//#define INVALID_TTI 53
...
//------------------------------------2023.10.13  weixing-------------------------
enum class srsran_rat_t { lte, nr,weixing, nulltype };
inline std::string to_string(const srsran_rat_t& type)
{
  constexpr static const char* options[] = {"LTE", "NR", "weixing"};
