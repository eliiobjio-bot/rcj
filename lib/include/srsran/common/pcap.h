...
// for rrc channel
typedef enum {
  CY_LOGICCHANNEL_TYPE_NULL,
  CY_LOGICCHANNEL_TYPE_MBCH,
  CY_LOGICCHANNEL_TYPE_SBCH,
  CY_LOGICCHANNEL_TYPE_PCCH,
  CY_LOGICCHANNEL_TYPE_TBCCH, // 物联网
  CY_LOGICCHANNEL_TYPE_BBCH,  // 接入网
  CY_LOGICCHANNEL_TYPE_DL_CCCH,
  CY_LOGICCHANNEL_TYPE_DL_DCCH,
  CY_LOGICCHANNEL_TYPE_UL_CCCH,
  CY_LOGICCHANNEL_TYPE_UL_DCCH,
} CY_LOGICCHANNEL_TYPE;
...
/* Direction */
#define DIRECTION_DOWNLINK CY_DIR_TYPE_DL
#define DIRECTION_UPLINK CY_DIR_TYPE_UL
...
#define MAC_XWNB_PAYLOAD_TAG 0x01
#define MAC_XWNB_RNTI_TAG 0x02
#define MAC_XWNB_UEID_TAG 0x03
#define MAC_XWNB_FRAME_SUBFRAME_TAG 0x04
#define MAC_XWNB_PREDFINED_DATA_TAG 0x05
#define MAC_XWNB_RETX_TAG 0x06
#define MAC_XWNB_CRC_STATUS_TAG 0x07
#define MAC_XWNB_CARRIER_ID_TAG 0x0A
...
typedef struct RRC_Context_Info_t {
  unsigned char direction;
  unsigned char nbiotMode;
  uint8_t       channel;
  uint8_t       reserve;
...
int XWNBIOT_PCAP_PACK_MAC_CONTEXT_TO_BUFFER(MAC_Context_Info_t* context, uint8_t* buffer, unsigned int length);
int XWNBIOT_PCAP_PACK_RRC_CONTEXT_TO_BUFFER(RRC_Context_Info_t* context, uint8_t* buffer, unsigned int length);
int XWNBIOT_PCAP_PACK_NAS_CONTEXT_TO_BUFFER(NAS_Context_Info_t* context, uint8_t* buffer, unsigned int length);
