...
#define  SUBINSTRU_KEY_VALUE(SubInstruIndex,Id) (Id|(SubInstruIndex<<6))

#define  MAX_SUPPORTED_VXI11_CLIENTID_COUNT					200

#define  MAX_SUPPORTED_VXI11_COMMANDCACHE_LENGTH			400000
#define  MAX_SUPPORTED_VXI11_PER_COMMAND_LENGTH				50000
#define  MAX_SUPPORTED_VXI11_REPLYCACHE_LENGTH				400000
#define  MAX_SUPPORTED_VXI11_PER_REPLY_LENGTH				50000


typedef enum
{
	CY_VXI11_EC_NULL = CY_GLOBAL_EC_VXI11,
	CY_VXI11_EC_SRVFUNCREPLYMEMORYERROR,
	CY_VXI11_EC_SRVFUNCCOMMANDCONTEXTMEMORYERROR,
	CY_VXI11_EC_SRVFUNCREPLYINSERTHASHERROR,
	CY_VXI11_EC_SRVFUNCDESTROYGETLINKERROR,
	CY_VXI11_EC_SRVFUNCWRITECOMMANDCACHEGETLINKERROR,
	CY_VXI11_EC_SRVFUNCREPLYCONTEXTMEMORYERROR,
	CY_VXI11_EC_SRVFUNCREPLYREADEHASHERROR,
	CY_VXI11_EC_SRVFUNCREPLYMOVEREADOUTOFRANGEERROR,
	CY_VXI11_EC_SRVFUNCSENDBUFFERHEADTAILERROR,
	
}CY_GLOBAL_VXI11_ERROR_CODE;
...
typedef struct
{
	...
	std::shared_ptr<char> pszCommand;
	int		nszCommandHead;
	int		nszCommandTail;
	int		nszCommandMaxLength;

	std::shared_ptr<char> pszReply;
	int		nszReplyHead;
	int		nszReplyTail;
	int		nszReplyMaxLength;
}CY_VXI11_COMMAND_REPLY_CONTEXT;
...
extern void start_vxi_server();
extern void stop_vxi11_server();
extern int device_send_reply(void* pvClientContext,const char* pszData,int nDataLength);
