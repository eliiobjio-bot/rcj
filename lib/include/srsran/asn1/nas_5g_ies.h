...
public:
  ...
  bool nea13_supported      = false; //nas 1.2
  bool nea14_supported      = false;
  ...
  bool nia13_supported      = false; //nas 1.2
  bool nia14_supported      = false;
...
public:
  struct Payload_container_type_type_ {
    enum options {
      ...
      /*2023-12-5 wcb*/
      ue_security_situation_info                     = 0b1101,
      ue_security_module_management_info             = 0b1110,
      /*2023-12-5 wcb*/
...
public:
  ...
  void           set(type_of_list_type::options e = type_of_list_type::list_of_ta_cs_belonging_to_one_plmn_or_snpn_with_non_consecutive_tac_values) { type_value = e; };

  struct number_of_elements_ {
    enum options {
      number_of_elements_1 = 0b00000,
      number_of_elements_2 = 0b00001,
      number_of_elements_3 = 0b00010,
      number_of_elements_4 = 0b00011,
      number_of_elements_5 = 0b00100,
      number_of_elements_6 = 0b00101,
      number_of_elements_7 = 0b00110,
      number_of_elements_8 = 0b00111,
      number_of_elements_9 = 0b01000,
      number_of_elements_10 = 0b01001,
      number_of_elements_11 = 0b01010,
      number_of_elements_12 = 0b01011,
      number_of_elements_13 = 0b01100,
      number_of_elements_14 = 0b01101,
      number_of_elements_15 = 0b01110,
      number_of_elements_16 = 0b01111,

    } value;
    const char* to_string();
  };
  typedef nas_enumerated<number_of_elements_, 5> number_of_elements;
  void           set(number_of_elements::options e = number_of_elements::number_of_elements_1) { number_of_value = e; };
  
  uint8_t getNum(number_of_elements::options e)
  {
    uint8_t num = 0;
    switch (e)
    {
    case number_of_elements::options::number_of_elements_1:
        num = 1;
        break;
    case number_of_elements::options::number_of_elements_2:
        num = 2;
        break;
    case number_of_elements::options::number_of_elements_3:
        num = 3;
        break;
    case number_of_elements::options::number_of_elements_4:
        num = 4;
        break;
    case number_of_elements::options::number_of_elements_5:
        num = 5;
        break;
    case number_of_elements::options::number_of_elements_6:
        num = 6;
        break;
    case number_of_elements::options::number_of_elements_7:
        num = 7;
        break;
    case number_of_elements::options::number_of_elements_8:
        num = 8;
        break;
    case number_of_elements::options::number_of_elements_9:
        num = 9;
        break;
    case number_of_elements::options::number_of_elements_10:
        num = 10;
        break;
    case number_of_elements::options::number_of_elements_11:
        num = 11;
        break;
    case number_of_elements::options::number_of_elements_12:
        num = 12;
        break;
    case number_of_elements::options::number_of_elements_13:
        num = 13;
        break;
    case number_of_elements::options::number_of_elements_14:
        num = 14;
        break;
    case number_of_elements::options::number_of_elements_15:
        num = 15;
        break;
    case number_of_elements::options::number_of_elements_16:
        num = 16;
        break;
    default:
        break;
  ...
  class non_consecutive_tac_values_s
  {
  public:
    Plmn_Struct plmn;
    std::array<Tac_Struct, 16> tac_t;

    uint64_t struct_tac_to_uint64(const Tac_Struct tac)
    {
        uint64_t Tac64 = 0;
        for (uint8_t i = 0; i < 3; i++)
        {
            Tac64 += ((uint64_t)tac.tac[i]) << (i * 8);
        }
    ...
    void getNum(const tracking_area_identity_list_5gs_t& outer)
    {
        set(outer.number_of_value);
    }

    SRSASN_CODE pack(asn1::bit_ref& bref, asn1::bit_ref& bref_tmp);
    SRSASN_CODE unpack(asn1::cbit_ref& bref, uint8_t tmp, uint32_t length);

    number_of_elements number_of_value = number_of_elements_::options::number_of_elements_1;
  }; // non_consecutive_tac_values

  class consecutive_tac_values_s
  {
  public:
    Tac_List_Struct  tac_str;
    ...
    number_of_elements number_of_value = number_of_elements_::options::number_of_elements_1;
  }; // consecutive_tac_values

  class different_plmn_s
  {
  public:
    std::array<Tac_List_Struct, 16> tac_str;
    uint64_t struct_tac_to_uint64(const Tac_Struct tac)
    {
        uint64_t Tac64 = 0;
        for (uint8_t i = 0; i < 3; i++)
  ...
  non_consecutive_tac_values_s& non_consecutive_tac_values()
  {
    asn1::assert_choice_type(type_of_list_type_::list_of_ta_cs_belonging_to_one_plmn_or_snpn_with_non_consecutive_tac_values, type_value, "list_of_ta_cs_belonging_to_one_plmn_or_snpn_with_non_consecutive_tac_values");
    return *srslog::detail::any_cast<non_consecutive_tac_values_s>(&choice_container);
  }

  consecutive_tac_values_s& consecutive_tac_values()
  {
    asn1::assert_choice_type(type_of_list_type_::list_of_ta_cs_belonging_to_one_plmn_or_snpn_with_consecutive_tac_values, type_value, "list_of_ta_cs_belonging_to_one_plmn_or_snpn_with_consecutive_tac_values");
    return *srslog::detail::any_cast<consecutive_tac_values_s>(&choice_container);
  }

  different_plmn_s& different_plmn()
  {
    asn1::assert_choice_type(type_of_list_type_::list_of_ta_is_belonging_to_different_plm_ns, type_value, "list_of_ta_is_belonging_to_different_plm_ns");
    return *srslog::detail::any_cast<different_plmn_s>(&choice_container);
  }
  
  non_consecutive_tac_values_s& set_non_consecutive_tac_values()
  {
    set(type_of_list_type::list_of_ta_cs_belonging_to_one_plmn_or_snpn_with_non_consecutive_tac_values);
    choice_container = srslog::detail::any{non_consecutive_tac_values_s()};
    return *srslog::detail::any_cast<non_consecutive_tac_values_s>(&choice_container);
  }

  consecutive_tac_values_s& set_consecutive_tac_values()
  {
    set(type_of_list_type::list_of_ta_cs_belonging_to_one_plmn_or_snpn_with_consecutive_tac_values);
    choice_container = srslog::detail::any{consecutive_tac_values_s()};
    return *srslog::detail::any_cast<consecutive_tac_values_s>(&choice_container);
  }

  different_plmn_s& set_different_plmn()
  {
    set(type_of_list_type::list_of_ta_is_belonging_to_different_plm_ns);
...
private:
  type_of_list_type type_value = type_of_list_type_::options::list_of_ta_cs_belonging_to_one_plmn_or_snpn_with_consecutive_tac_values;
  number_of_elements number_of_value = number_of_elements_::options::number_of_elements_1;
  srslog::detail::any choice_container;
...
{
public:
  std::vector<uint8_t>     pf_content;
  SRSASN_CODE pack(asn1::bit_ref& bref);
  SRSASN_CODE unpack(asn1::cbit_ref& bref);
};

struct pacret_filter_type2_t {
public:
  struct packet_filter_direction_type_ {
    enum options {
      reserved      = 0b00,
      downlink_only = 0b01,
      uplink_only   = 0b10,
  ...
  typedef nas_enumerated<packet_filter_direction_type_, 2> packet_filter_direction_type;
  packet_filter_direction_type packet_filter_direction = packet_filter_direction_type_::options::bidirectional;

  uint8_t      packet_filter_id = 0;
  pf_content_t pf_cont;
  // uint8_t pf_content=1;
...
public:
  ...
  typedef nas_enumerated<QFI_type_, 6> QFI_type;
  QFI_type                             QFI = QFI_type_::options::QFI_2;
  struct Segregation_type_ {
    enum options {
  ...
  typedef nas_enumerated<Segregation_type_, 1> Segregation_type;
  Segregation_type                             Segregation = Segregation_type_::options::Segregation_not_requested;
...
public:
  pacret_filter_type2_t pacret_filter_type2;
  QFI_cont_t            QFI_cont;
  uint8_t               Qos_rules_precedence = 0;
  SRSASN_CODE           pack(asn1::bit_ref& bref);
  SRSASN_CODE           unpack(asn1::cbit_ref& bref);
};
...
public:
  ...
  typedef nas_enumerated<QRI_type_, 8> QRI_type;
  QRI_type                             QRI = QRI_type_::options::QRI_9;

  struct DQR_type_ {
    enum options {
      no_default_QoS_rule = 0b0,
      default_QoS_rule    = 0b1,
    } value;
    const char* to_string();
  };
  typedef nas_enumerated<DQR_type_, 1> DQR_type;
  DQR_type                             DQR = DQR_type_::options::default_QoS_rule;

  struct Rule_operation_code_type_ {
    enum options {
      Reserved                                                  = 0b00,
  ...
  typedef nas_enumerated<Rule_operation_code_type_, 3> Rule_operation_code_type;
  Rule_operation_code_type Rule_operation_code = Rule_operation_code_type_::options::Create_new_QoS_rule;

  uint8_t packet_filter_num = 1;
...
// IE: QoS flow descriptions
// Reference: 9.11.4.12
class QI5_parameter_contents_t
{
public:
  struct parameter_id_type_{
    enum options {
      QI5                 = 0b00000001,
      GFBR_uplink         = 0b00000010,
      GFBR_downlink       = 0b00000011,
      MFBR_uplink         = 0b00000100,
      MFBR_downlink       = 0b00000101,
      Averaging_window    = 0b00000110,
      EPS_bearer_identity = 0b00000111,
    } value;
    const char* to_string();
  };
  typedef nas_enumerated<parameter_id_type_, 8> parameter_id_type;
  parameter_id_type parameter_id1=parameter_id_type_::QI5;
  ...
  typedef nas_enumerated<QI5_type_, 8> QI5_type;
  QI5_type                             QI5 = QI5_type_::options::QI5_4;
...
{
public:
  struct guaranteed_flow_type_{
  enum options {
      value_not_used              = 0b00000000,
      value_1_Kbps                = 0b00000001,
      value_4_Kbps                = 0b00000010,
      value_16_Kbps               = 0b00000011,
      value_64_Kbps               = 0b00000100,
      value_256_Kbps              = 0b00000101,
      value_1_Mbps                = 0b00000110,
      value_4_Mbps                = 0b00000111,
      value_16_Mbps               = 0b00001000,
      value_64_Mbps               = 0b00001001,
      value_256_Mbps              = 0b00001010,
      value_1_Gbps                = 0b00001011,
      value_4_Gbps                = 0b00001100,
      value_16_Gbps               = 0b00001101,
      value_64_Gbps               = 0b00001110,
      value_256_Gbps              = 0b00001111,
      value_1_Tbps                = 0b00010000,
      value_4_Tbps                = 0b00010001,
      value_16_Tbps               = 0b00010010,
      value_64_Tbps               = 0b00010011,
      value_256_Tbps              = 0b00010100,
      value_1_Pbps                = 0b00010101,
      value_4_Pbps                = 0b00010110,
      value_16_Pbps               = 0b00010111,
      value_64_Pbps               = 0b00011000,
      value_256_Pbps              = 0b00011001,
    } value;
    const char* to_string();
  };
  typedef nas_enumerated<guaranteed_flow_type_, 8> guaranteed_flow_type;
  guaranteed_flow_type guaranteed_flow=guaranteed_flow_type_::value_1_Kbps;

  uint8_t guaranteed_flow_bit_rate1=0;
  uint8_t guaranteed_flow_bit_rate2=1;

  SRSASN_CODE pack(asn1::bit_ref& bref);
  SRSASN_CODE unpack(asn1::cbit_ref& bref);  
};

class GFBR_uplink_parameter_contents_t
{
public:
  struct parameter_id_type_{
    enum options {
  ...
  typedef nas_enumerated<parameter_id_type_, 8> parameter_id_type;
  parameter_id_type parameter_id2=parameter_id_type_::GFBR_uplink;
...
class Averaging_window_parameter_contents_t
{
public:
  SRSASN_CODE pack(asn1::bit_ref& bref);
  SRSASN_CODE unpack(asn1::cbit_ref& bref);  
...
class EPS_bearer_identity_parameter_contents_t
{
public:
  SRSASN_CODE pack(asn1::bit_ref& bref);
  SRSASN_CODE unpack(asn1::cbit_ref& bref);  
...
class parameters_list_t
{
public:
  QI5_parameter_contents_t parameter1;
  GFBR_uplink_parameter_contents_t parameter2;
  std::vector<QI5_parameter_contents_t> parameters1;
  std::vector<GFBR_uplink_parameter_contents_t> parameters2;
  
  SRSASN_CODE pack(asn1::bit_ref& bref);
  SRSASN_CODE unpack(asn1::cbit_ref& bref);
};

class qo_s_flow_description_t
{
public:
  struct QFI_type_ {
    enum options {
  ...
  typedef nas_enumerated<QFI_type_, 6> QFI_type;
  QFI_type                             QFI = QFI_type_::options::QFI_3;

  struct operation_code_type_ {
    enum options {
      Reserved                                                  = 0b00,
      Create_new_QoS_flow_description                           = 0b001,
      Delete_existing_QoS_flow_description                      = 0b010,
      Modify_existing_QoS_flow_description                      = 0b011,
    } value;
    const char* to_string();
  };
  typedef nas_enumerated<operation_code_type_, 3> operation_code_type;
  operation_code_type operation_code = operation_code_type_::options::Create_new_QoS_flow_description;
  
  struct E_type_{
    enum options {
      Reserved                                                  = 0b0,
      parameters_list_is_included                               = 0b1,
    } value;
    const char* to_string();
  };
  typedef nas_enumerated<E_type_, 1> E_type;
  E_type E = E_type_::options::parameters_list_is_included;

  parameters_list_t parameters_list;

  uint8_t parameters_num = 5;
...
{
public:
  qo_s_flow_description_t              qo_s_flow_description;
  std::vector<qo_s_flow_description_t> qo_s_flow_descriptions;
  SRSASN_CODE             pack(asn1::bit_ref& bref);
  SRSASN_CODE             unpack(asn1::cbit_ref& bref);
...
//TC
class ue_test_loop_mode_t
{
public:
  struct ue_test_loop_mode_ {
    enum options {
      ue_test_loop_mode_a       = 0x00,
      ue_test_loop_mode_b       = 0x01,

    } value;
    const char* to_string();
  };
  typedef nas_enumerated<ue_test_loop_mode_, 8> ue_test_loop_mode;


  ue_test_loop_mode  type_value = ue_test_loop_mode_::options::ue_test_loop_mode_a;
...
class ue_test_loop_mode_a_lb_setup_t
{
public:
struct lb_setup_drb{
    uint16_t z;
  ...
  std::vector<lb_setup_drb> lb_setup_list;


  SRSASN_CODE pack(asn1::bit_ref& bref);
  SRSASN_CODE unpack(asn1::cbit_ref& bref);

}; // called_party_bcd_number_t

class ue_test_loop_mode_b_lb_setup_t
{
public:

  uint8_t ip_pdu_delay;
