...
public:
  ...
  // Optional fields
  bool pdu_session_status_present                          = false;
  bool pdu_session_reactivation_result_present_s           = false;
  bool pdu_session_reactivation_result_error_cause_present = false;
  bool eap_message_present                                 = false;
  bool t3448_value_present                                 = false;
...
//TC
class close_ue_test_loop_t
{
public:
  // Mandatory fields
  ue_test_loop_mode_t           ue_test_loop_mode;

  //Conditional fieldsc
  bool ue_test_loop_mode_a_lb_setup_present = false;
  bool ue_test_loop_mode_b_lb_setup_present = false;

  ue_test_loop_mode_a_lb_setup_t                   ue_test_loop_mode_a_lb_setup;
  ue_test_loop_mode_b_lb_setup_t                   ue_test_loop_mode_b_lb_setup;
...
}; // close_ue_test_loop_t

class close_ue_test_loop_complete_t
{
public:
...
}; // close_ue_test_loop_complete_t

class open_ue_test_loop_t
{
public:
...
class open_ue_test_loop_complete_t
{
public:
...
}; // open_ue_test_loop_complete_t

class activate_test_mode_t
{
public:
  ue_test_loop_mode_t           ue_test_loop_mode;
...
class activate_test_mode_complete_t
{
public:
...
}; // activate_test_mode_complete_t

class deactivate_test_mode_t
{
public:
...
}; // deactivate_test_mode_t

class deactivate_test_mode_complete_t
{
public:
...
}; // deactivate_test_mode_complete_t
...
struct msg_opts {
  enum options {
    ...
    status_5gsm                             = 0xd6,
//TC
    close_ue_test_loop                              = 0b10000000,
    close_ue_test_loop_complete                     = 0b10000001,
    open_ue_test_loop                               = 0b10000010,
    open_ue_test_loop_complete                      = 0b10000011,
    active_test_mode                                = 0b10000100,
    active_test_mode_complete                       = 0b10000101,
    deactive_test_mode                              = 0b10000110,
    deactive_test_mode_complete                     = 0b10000111,
    nulltype                                = 0xff,
...
//TC
      case close_ue_test_loop:
          return "close_ue_test_loop";
      case close_ue_test_loop_complete:
          return "close_ue_test_loop_complete";
      case open_ue_test_loop:
          return "open_ue_test_loop";
      case open_ue_test_loop_complete:
          return "open_ue_test_loop_complete";
      case active_test_mode:
          return "active_test_mode";
      case active_test_mode_complete:
          return "active_test_mode_complete";
      case deactive_test_mode:
          return "deactive_test_mode";
      case deactive_test_mode_complete:
          return "deactive_test_mode_complete";
      default:
        return "Error";
    }
  }
...
struct nas_5gs_hdr {
  ...
  enum extended_protocol_discriminator_opts {
    ...
    extended_protocol_discriminator_test_loop = 0x0f,
  };
  ...
  uint8_t spare_1_2_version            = 0x00;
  ...
  // Inner
  uint8_t inner_spare_1_2_version            = 0x01;
...
//TC
  close_ue_test_loop_t& close_ue_test_loop()
  {
    asn1::assert_choice_type(msg_types::options::close_ue_test_loop, hdr.message_type, "close_ue_test_loop");
    return *srslog::detail::any_cast<close_ue_test_loop_t>(&msg_container);
  }

  close_ue_test_loop_complete_t& close_ue_test_loop_complete()
  {
    asn1::assert_choice_type(msg_types::options::close_ue_test_loop_complete, hdr.message_type, "close_ue_test_loop_complete");
    return *srslog::detail::any_cast<close_ue_test_loop_complete_t>(&msg_container);
  }

  open_ue_test_loop_t& open_ue_test_loop()
  {
    asn1::assert_choice_type(msg_types::options::open_ue_test_loop, hdr.message_type, "open_ue_test_loop");
    return *srslog::detail::any_cast<open_ue_test_loop_t>(&msg_container);
  }

  open_ue_test_loop_complete_t& open_ue_test_loop_complete()
  {
    asn1::assert_choice_type(msg_types::options::open_ue_test_loop_complete, hdr.message_type, "open_ue_test_loop_complete");
    return *srslog::detail::any_cast<open_ue_test_loop_complete_t>(&msg_container);
  }

  activate_test_mode_t& activate_test_mode()
  {
    asn1::assert_choice_type(msg_types::options::active_test_mode, hdr.message_type, "active_test_mode");
    return *srslog::detail::any_cast<activate_test_mode_t>(&msg_container);
  }

  activate_test_mode_complete_t& activate_test_mode_complete()
  {
    asn1::assert_choice_type(msg_types::options::active_test_mode_complete, hdr.message_type, "active_test_mode_complete");
    return *srslog::detail::any_cast<activate_test_mode_complete_t>(&msg_container);
  }

  deactivate_test_mode_t& deactivate_test_mode()
  {
    asn1::assert_choice_type(msg_types::options::deactive_test_mode, hdr.message_type, "deactive_test_mode");
    return *srslog::detail::any_cast<deactivate_test_mode_t>(&msg_container);
  }

  deactivate_test_mode_complete_t& deactivate_test_mode_complete()
  {
    asn1::assert_choice_type(msg_types::options::deactive_test_mode_complete, hdr.message_type, "deactive_test_mode_complete");
    return *srslog::detail::any_cast<deactivate_test_mode_complete_t>(&msg_container);
  }


// Setters

    close_ue_test_loop_t& set_close_ue_test_loop()
  {
    set(msg_types::options::close_ue_test_loop);
    hdr.extended_protocol_discriminator       = nas_5gs_hdr::extended_protocol_discriminator_test_loop;
    hdr.inner_extended_protocol_discriminator = nas_5gs_hdr::extended_protocol_discriminator_test_loop;
    msg_container                             = srslog::detail::any{close_ue_test_loop_t()};
    return *srslog::detail::any_cast<close_ue_test_loop_t>(&msg_container);
  }

  close_ue_test_loop_complete_t& set_close_ue_test_loop_complete()
  {
    set(msg_types::options::close_ue_test_loop_complete);
    hdr.extended_protocol_discriminator       = nas_5gs_hdr::extended_protocol_discriminator_test_loop;
    hdr.inner_extended_protocol_discriminator = nas_5gs_hdr::extended_protocol_discriminator_test_loop;
    msg_container                             = srslog::detail::any{close_ue_test_loop_complete_t()};
    return *srslog::detail::any_cast<close_ue_test_loop_complete_t>(&msg_container);
  }

  open_ue_test_loop_t& set_open_ue_test_loop_t()
  {
    set(msg_types::options::open_ue_test_loop);
    hdr.extended_protocol_discriminator       = nas_5gs_hdr::extended_protocol_discriminator_test_loop;
    hdr.inner_extended_protocol_discriminator = nas_5gs_hdr::extended_protocol_discriminator_test_loop;
    msg_container                             = srslog::detail::any{open_ue_test_loop_t()};
    return *srslog::detail::any_cast<open_ue_test_loop_t>(&msg_container);
  }

  open_ue_test_loop_complete_t& set_open_ue_test_loop_complete_t()
  {
    set(msg_types::options::open_ue_test_loop_complete);
    hdr.extended_protocol_discriminator       = nas_5gs_hdr::extended_protocol_discriminator_test_loop;
    hdr.inner_extended_protocol_discriminator = nas_5gs_hdr::extended_protocol_discriminator_test_loop;
    msg_container                             = srslog::detail::any{open_ue_test_loop_complete_t()};
    return *srslog::detail::any_cast<open_ue_test_loop_complete_t>(&msg_container);
  }

  activate_test_mode_t& set_activate_test_mode_t()
  {
    set(msg_types::options::active_test_mode);
    hdr.extended_protocol_discriminator       = nas_5gs_hdr::extended_protocol_discriminator_test_loop;
    hdr.inner_extended_protocol_discriminator = nas_5gs_hdr::extended_protocol_discriminator_test_loop;
    msg_container                             = srslog::detail::any{activate_test_mode_t()};
    return *srslog::detail::any_cast<activate_test_mode_t>(&msg_container);
  }

  activate_test_mode_complete_t& set_activate_test_mode_complete_t()
  {
    set(msg_types::options::active_test_mode_complete);
    hdr.extended_protocol_discriminator       = nas_5gs_hdr::extended_protocol_discriminator_test_loop;
    hdr.inner_extended_protocol_discriminator = nas_5gs_hdr::extended_protocol_discriminator_test_loop;
    msg_container                             = srslog::detail::any{activate_test_mode_complete_t()};
    return *srslog::detail::any_cast<activate_test_mode_complete_t>(&msg_container);
  }

  deactivate_test_mode_t& set_deactivate_test_mode_t()
  {
    set(msg_types::options::deactive_test_mode);
    hdr.extended_protocol_discriminator       = nas_5gs_hdr::extended_protocol_discriminator_test_loop;
    hdr.inner_extended_protocol_discriminator = nas_5gs_hdr::extended_protocol_discriminator_test_loop;
    msg_container                             = srslog::detail::any{deactivate_test_mode_t()};
    return *srslog::detail::any_cast<deactivate_test_mode_t>(&msg_container);
  }

  deactivate_test_mode_complete_t& set_deactivate_test_mode_complete_t()
  {
    set(msg_types::options::deactive_test_mode_complete);
    hdr.extended_protocol_discriminator       = nas_5gs_hdr::extended_protocol_discriminator_test_loop;
    hdr.inner_extended_protocol_discriminator = nas_5gs_hdr::extended_protocol_discriminator_test_loop;
    msg_container                             = srslog::detail::any{deactivate_test_mode_complete_t()};
    return *srslog::detail::any_cast<deactivate_test_mode_complete_t>(&msg_container);
  }
