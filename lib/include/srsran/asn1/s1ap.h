...
//--------------------------------2023/10/26-------------------------------------
enum acc_stratum_rel_t { r1, r2, spare6, spare5, spare4, spare3, spare2, spare1 };

struct ue_capab_s {
  acc_stratum_rel_t acc_stratum_rel;
  uint8_t           ue_category_r1;
};

struct init_ctxt_setup_req_s {
  ue_aggregate_maximum_bitrate_s    ueaggregate_maximum_bitrate;
  ue_security_cap_s                 ue_security_cap;
  fixed_bitstring<256, false, true> security_key;
};

struct ctxt_mod_req_s {
  bool                              security_key_present                 = false;
  bool                              ueaggreagate_maximum_bitrate_present = false;
  bool                              ue_security_cap_present              = false;
  fixed_bitstring<256, false, true> security_key;
  ue_aggregate_maximum_bitrate_s    ueaggregate_maximum_bitrate;
  ue_security_cap_s                 ue_security_cap;
