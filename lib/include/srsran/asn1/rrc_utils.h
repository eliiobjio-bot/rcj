...
//--------------------------2023.10.21---------------------
rlc_config_t make_rlc_confg_t(const asn1::rrc::rlc_cofg_c& asn1_type);
//void        to_asn1(asn1::rrc::rlc_cofg_c* asn1_type, const rlc_config_t& cofg);
//--------------------------------------------------------
/***************************
 *      PDCP Config
 **************************/
...
//----------------------------2023.10.20----------------------------------------
srsran::pdcp_confg_t 
make_drb_pdcp_confg_t(const uint8_t bearer_id, const asn1::rrc::pdcp_cofg_s& pdcp_cofg);
//------------------------------------------------------------------------------------
/***************************
/***************************
 *      MAC Config
