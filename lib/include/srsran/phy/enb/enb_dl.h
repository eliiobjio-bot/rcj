...
SRSRAN_API int srsran_enb_dl_init(srsran_enb_dl_t* q, cf_t* out_buffer[SRSRAN_MAX_PORTS], uint32_t max_prb,float* XW_buffer_i[SRSRAN_MAX_PORTS],float* XW_buffer_q[SRSRAN_MAX_PORTS]);
...
SRSRAN_API void srsran_enb_dl_gen_signal_multi_cc(srsran_prach_t *xw_para,srsran_enb_dl_t *q,float *CommonMemory,int all_cc_number);

SRSRAN_API void XW_DS_rsran_enb_dl_gen_signal(srsran_enb_dl_t *q);
