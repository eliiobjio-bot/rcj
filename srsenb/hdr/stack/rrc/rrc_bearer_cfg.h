...
public:
  ...
  bool set_security_capabilities(const asn1::s1ap::ue_security_cap_s& caps,bool ttcn_test_enble,bool is_paging_smc);
  ...
  asn1::rrc::security_algorithm_cfg_s get_security_algorithm_cfg();
    //-------------------------------------2023/10/12---------------------------------------------//
  asn1::rrc::sec_alg_cfg_s get_sec_alg_cfg();
  //-----------------------------------------------------------------------
...
public:
 ...
 //-----------------------------------2023.10.13----------------------------------
  void s_fill_pending_nas_info(asn1::rrc::rrc_con_recfg_r1_ies_s* msg);
  //----------------------------------------------------------------------------------
 ...
 //-------------------------------2023.10.27-------------------------------
  const asn1::rrc::drb_to_add_modi_list_s& s_get_established_drbs() const { return curr_drbs; }
...
private:
  ...
  //--------------------2023.10.27-------------------------
  asn1::rrc::drb_to_add_modi_list_s curr_drbs;
  //-------------------------------------------------
  // last cfg
