...
namespace srsenb
{
  ...
  // Per eNB SIBs
  // ----------2022/07/29------------
  asn1::rrc::mib_wx_s        mib;
  asn1::rrc::sib_wx_s        sib;
  //---------------------------------

    /*
     * @ filename
     */
    std::string reconf_data_config;
    std::string reconf_voice_config;
    std::string reconf_voice_ds_config;
    std::string reconf_data_ds_config;
    std::string mib_config;

    //-----2024.03.22----
    asn1::rrc::s_dl_dcch_msg_s recfg_wx;
    asn1::rrc::s_dl_dcch_msg_s recfg_wx_voice;
    asn1::rrc::s_dl_dcch_msg_s recfg_wx_kuopin;
    ...
    uint8_t rlc_mode;//0 AM, 1 UM, 2 TM
  };

  constexpr uint32_t UE_PCELL_CC_IDX = 0;
  //-----------------------------2023.10.13-------------------------
  struct s_ue_var_cfg_t
  {
    asn1::rrc::redio_resour_cfg_dedi_s rr_cofg;
    asn1::rrc::meas_cofg_s meas_cofg;
