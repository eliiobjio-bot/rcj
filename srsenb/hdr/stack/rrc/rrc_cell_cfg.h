...
//-----------------2022/07/29--------------
  asn1::rrc::mib_wx_s               mib_wx;
  asn1::rrc::sib_wx_s               sib_wx;
  //-----------------------------------------
 
//-----------------IoT SI------------------
//---------------2023-08-10----------------
  asn1::rrc::iot_sib_s              iot_si;
  std::vector<srsran::unique_byte_buffer_t> iot_si_buffer;
//-----------------------------------------
...
// --------------2022/07/29----------------
  std::vector<srsran::unique_byte_buffer_t> mib_buffer;    ///< Packed MIB for given CC
  std::vector<srsran::unique_byte_buffer_t> sib_wx_buffer; ///< Packed SIB for given CC
  
    //-----2024.03.22------
  std::vector<srsran::unique_byte_buffer_t> recfg_wx_buffer;
  asn1::rrc::s_dl_dcch_msg_s                recfg_wx;

  std::vector<srsran::unique_byte_buffer_t> recfg_voice_buffer;
  asn1::rrc::s_dl_dcch_msg_s                recfg_voice;

  std::vector<srsran::unique_byte_buffer_t> recfg_kuopin_buffer;
  asn1::rrc::s_dl_dcch_msg_s                recfg_kuopin;

  std::vector<srsran::unique_byte_buffer_t> recfg_norm_kuopin_buffer;
  asn1::rrc::s_dl_dcch_msg_s                recfg_norm_kuopin;
