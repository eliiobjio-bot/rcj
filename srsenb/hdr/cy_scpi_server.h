...
public:
  SCPI_SERVER() = default;
  SCPI_SERVER(srslog::sink& log_sink, uint16_t p=33770):thread("SCPI_SERVER"),server_log(srslog::fetch_basic_logger("SCPI_SERVER", log_sink, false)), tcp_port(p)
  {
