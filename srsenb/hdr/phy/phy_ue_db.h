...
private:
  ...
  struct cell_info_t {
    ...
    bool                                    stash_use_tbs_index_alt = false;
     //--------------------------------------------
    srsran::phy_ch_cfog_t         phy_chan_cfg;
    //-----------------------------------------
 ...
 //------------------------2023.10.30-------------------------------
  inline void _set_comm_cofg_rnti(uint16_t rnti, srsran::phy_ch_cfog_t& phy_cfg) const;
  //---------------------------------------------------------------------
  /**
...
//-----------------------------2023.10.28------------------------------------
  void s_addmod_rnti(uint16_t rnti, const phy_interface_rrc_lte::phy_rrc_cfg_list_t& phy_cfg_list);
  //------------------------------------------------------------------
  /**
