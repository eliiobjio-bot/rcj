...
// V1.0.0#################################
int  get_sched(uint32_t tti, std::vector<sched_t>&dl_shced_res, uint32_t prach_tti) {return 0;}
int  get_IoT_sched(uint32_t tti, std::vector<sched_t>&dl_shced_res) {return 0;}
int rach_detected(prachInfo_t* prachInfo, uint8_t* pdu, int pduLen){return 0;}
int sych_detected(psychInfo_t* psychInfo) {return 0;}
//int sych_update(psychInfo_t* psychInfo){return 0;}
int iot_rach_detected(iot_prachInfo_t* iot_prachInfo, uint8_t* pdu, int pduLen){return 0;}
 ...
 int  parse_psych_pdu(uint32_t tti_rx,uint16_t rnti,uint8_t *msg,uint32_t pduLen,bool  crc) {return 0;};
//#################################################
