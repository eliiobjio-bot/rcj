...
int parse_mib(std::string filename, asn1::rrc::mib_wx_s* data);
int parse_sib(all_args_t* args_,std::string filename, asn1::rrc::sib_wx_s* data);
int parse_sib_wx(all_args_t* args_, rrc_cfg_t* rrc_cfg_);
//-------------------------------------------

//-----------2024.03.22----
    int parse_recfg_wx(all_args_t* args_, rrc_cfg_t* rrc_cfg_);
    int parse_recfg(all_args_t* args_, std::string filename, asn1::rrc::s_dl_dcch_msg_s* data);

    int parse_recfg_voice(all_args_t* args_, rrc_cfg_t* rrc_cfg_);
    int parse_recfg_vo(all_args_t* args_, std::string filename, asn1::rrc::s_dl_dcch_msg_s* data);


    int parse_recfg_kuopin(all_args_t* args_, rrc_cfg_t* rrc_cfg_);
    int parse_recfg_kp(all_args_t* args_, std::string filename, asn1::rrc::s_dl_dcch_msg_s* data);

    int parse_norm_recfg_kuopin(all_args_t* args_, rrc_cfg_t* rrc_cfg_);
    int parse_norm_recfg_kp(all_args_t* args_, std::string filename, asn1::rrc::s_dl_dcch_msg_s* data);
