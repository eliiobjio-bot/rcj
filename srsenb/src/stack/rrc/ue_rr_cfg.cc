...
// //--------------------------------2022/08/04------------------------------
// void generate_rr_cfg_ded_setup(asn1::rrc::radio_resurce_cfg_ded_s& rr_cfg_ded) 
// {
//   rr_cfg_ded = {};
...
//   rr_cfg_ded.periodic_bsr_timer         = radio_resurce_cfg_ded_s::periodic_bsr_timer_opts::rf2;

//   // SecurityAlgorithmConfig
//   rr_cfg_ded.security_cfg_present = true;
//   security_alg_cfg_s& secur_cfg   = rr_cfg_ded.security_cfg;
//   secur_cfg.ci_phe_algorithm      = security_alg_cfg_s::ci_phe_algorithm_opts::nea1;
//   secur_cfg.int_prot_algorithm_present = true;
//   secur_cfg.int_prot_algorithm         = security_alg_cfg_s::int_prot_algorithm_opts::nia1;
...
int s_apply_reconf_updates(asn1::rrc::rrc_conn_recfg_r8_ies_s&  recfg_r8,
                           asn1::rrc::rrc_con_recfg_r1_ies_s& recfg_r1,
                           ...
                           const srsran::rrc_ue_capabilities_t& ue_caps)
{
  ...
  fill_scells_reconf(recfg_r8, cur_ue_cfg.scells, enb_cfg, ue_cell_list, ue_caps);
  recfg_r8.meas_cfg_present |= recfg_r8.meas_cfg.meas_gap_cfg_present;
  //if (s_fill_rr_cfg_ded_reconf(recfg_r1.redio_resour_cfg_dedi, cur_ue_cfg.rr_cofg, enb_cfg, bearers)) {
  // return SRSRAN_ERROR;
  //}
  // Add pending NAS info
   std::cout<<"@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@xxx2"<<std::endl;
  bearers.s_fill_pending_nas_info(&recfg_r1);

  // Update current rr_cfg_ded state
 std::cout<<"@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@xxx3"<<std::endl;
  //s_apply_rr_cfg_ded_diff(cur_ue_cfg.rr_cofg, recfg_r1.redio_resour_cfg_dedi);
  apply_scells_to_add_diff(cur_ue_cfg.scells, recfg_r8);
