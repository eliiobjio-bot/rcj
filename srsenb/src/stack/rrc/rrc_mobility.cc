                                                 ...
                                                 bool     fwd_direct_path_available)
{
  ...
  if (not rrc_ue->eutra_capabilities_unpacked) {
    ...
    bzero(static_cast<void*>(&capitem.pdcp_params.supported_rohc_profiles),
                                              ...
                                              asn1::s1ap::cause_c&                  cause)
{
  ...
  // Regenerate AS Keys
  // See TS 33.401, Sec. 7.2.8.4.3
  if (not rrc_ue->ue_security_cfg.set_security_capabilities(ho_req_msg.protocol_ies.ue_security_cap.value,0,0)) {
